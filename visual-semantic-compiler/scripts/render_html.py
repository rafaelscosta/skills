...
import argparse, hashlib, html, importlib.util, json, os, subprocess, sys, tempfile
...
def render_svg(ir,layout):
    w=layout['viewport']['width'];h=layout['viewport']['height'];typ=layout['representation_type']; node_by={n['id']:n for n in layout['nodes']}
